...
namespace BugTracker.Infrastructure.Migrations
{
    ...
    [Migration("20230529085257_CommentInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTracker.Domain.Entities.Commentary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BugTracker.Domain.Entities.ProjectUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BugTracker.Domain.Entities.Commentary", b =>
                {
                    b.HasOne("BugTracker.Domain.Entities.Identity.ApplicationUser", "CreatedByUser")
                        .WithMany("Commentary")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BugTracker.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
